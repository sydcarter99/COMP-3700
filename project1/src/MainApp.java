...
public class MainApp {
    public static void main(String[] args) {
        ...
        StoreManager.getInstance().getOrdersView().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        StoreManager.getInstance().getOrdersView().setVisible(true); // Show the ProductView!
    }
}
